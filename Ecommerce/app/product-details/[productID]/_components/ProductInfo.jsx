...
const ProductInfoSkeleton = () => {
  return (
    ...
    <div className="h-[18px] animate-pulse w-[250px] bg-slate-200"/>
    <div className="h-[18px] animate-pulse w-[50px] bg-slate-200"/>
    <div className='h-[18px] animate-pulse w-[200px] bg-slate-200'/>

    <div className='h-[18px] animate-pulse w-[200px] bg-slate-200' />
    <div className='h-[18px] animate-pulse w-[200px] bg-slate-200' />
    <div className='h-[18px] animate-pulse w-[100px] bg-slate-200' />
  </div>
  )
}